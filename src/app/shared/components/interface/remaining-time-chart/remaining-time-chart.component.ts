...
@Component({
    ...
    styleUrls: ['./remaining-time-chart.component.scss']
})
export class RemainingTimeChartComponent implements AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        this.createSection(0 + 20, sectionDegrees, '#F3A33A');
        this.createSection(sectionDegrees, 360 - sectionDegrees + 20, '#F9D19C');
